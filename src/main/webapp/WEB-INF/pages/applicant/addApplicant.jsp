<%-- 
    ...
    Created on : 09.01.2021, 22:37:30
    Author     : Sebi
--%>
...
<t:pageTemplate pageTitle = "Add User">
    ...
    <div class="row mt-lg-5  pt-lg-5">
        ...
        <div class="col-lg-4">
            <h1 class="title-pages">Add Applicant</h1>
            <form class="needs-validation" novalidate method="POST" action="${pageContext.request.contextPath}/Applicant/Create">
                <div class="mb-lg-3">
                ...
                <div class="mb-lg-3">
                    ...
                    <div class="invalid-feedback">
                        Choosing a Surname is required.
                    </div>
                </div>
                <div class="mb-lg-3">
                ...
                <div class="mb-lg-3">
                    ...
                    <div class="invalid-feedback">
                        Choosing a Password is required.
                    </div>
                </div>
                <div class="mb-lg-3">
