    ...
    <div class="col-md-8 order-md-1">
        <form class="needs-validation" novalidate method="POST" action="${pageContext.request.contextPath}/addUser">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="nume" id="nume" placeholder="nume" required>
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="prenume" id="prenume" placeholder="prenume" required>
                <div class="invalid-feedback">
                    Surname is required.
                </div>
            </div>
